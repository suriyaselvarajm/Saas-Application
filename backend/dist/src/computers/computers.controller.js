...
const modify_computer_dto_1 = require("./dto/modify-computer.dto");
...
let ComputersController = class ComputersController {
    ...
    async createBulkComputers(tenantId, body) {
    ...
    async modifyBulkComputers(tenantId, body) {
...
], ComputersController.prototype, "getTemplates", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ComputersController.prototype, "saveTemplate", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ComputersController.prototype, "deleteTemplate", null);
__decorate([
    (0, common_1.Get)(),
    ...
    __metadata("design:returntype", Promise)
], ComputersController.prototype, "searchComputers", null);
__decorate([
    (0, common_1.Post)('create-single'),
    __param(0, (0, tenant_id_decorator_1.TenantId)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_computer_dto_1.CreateComputerDto]),
    __metadata("design:returntype", Promise)
], ComputersController.prototype, "createSingleComputer", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ComputersController.prototype, "createBulkComputers", null);
__decorate([
    (0, common_1.Patch)('modify-single'),
    __param(0, (0, tenant_id_decorator_1.TenantId)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, modify_computer_dto_1.ModifyComputerDto]),
    __metadata("design:returntype", Promise)
], ComputersController.prototype, "modifySingleComputer", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ComputersController.prototype, "modifyBulkComputers", null);
