    ...
    stages {
        ...
        stage('Install Dependencies') {
            steps {
                ...
                sh '''
                cd backend && npm cache clean --force && rm -rf node_modules && npm install && chmod -R +x node_modules/.bin
                cd ../frontend && npm cache clean --force && rm -rf node_modules && npm install && chmod -R +x node_modules/.bin
                '''
            }
        }
